...
\]
The dataset stores both the truth coefficients and an attached-flow nominal coefficient set; their difference is the hidden nonlinear aerodynamic residual.
