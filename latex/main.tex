...
\begin{figure}[hbt!]
    ...
    \caption{Training-time versus validation-error tradeoff for the 6-DOF benchmark. The red dashed horizontal line gives the attached-flow nominal baseline, which has no fitted training solve. Marker area increases with validation rollout time.}
