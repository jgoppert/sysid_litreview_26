...
The implementation is currently a compatibility layer over `methods/simulation/longitudinal.py` so existing dataset-generation commands keep working. New benchmark code should import from:
