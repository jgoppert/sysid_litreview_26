"""Internal nonlinear 6DOF aircraft benchmark implementation.

Public benchmark code should import these dynamics through
``models.aircraft6dof.greybox``.  This module remains as the compatibility
implementation backing that grey-box API.
"""
